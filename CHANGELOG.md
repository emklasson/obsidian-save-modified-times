...
- ## 1.1.0 (2026-01-09)
	...
	- Added commands for saving/restoring the current note's last modified time to/from the plugin's `data.json`.
	- **Save format updated. Previously saved "all files' modified times" are discarded when updating to this version.**
